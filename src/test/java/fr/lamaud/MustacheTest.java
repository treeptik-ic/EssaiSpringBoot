...
//
//		ResponseEntity<String> entity = this.restTemplate.getForEntity("/mustache/welcome", String.class);
...
//		headers.setAccept(Arrays.asList(MediaType.TEXT_HTML));
//		HttpEntity<String> requestEntity = new HttpEntity<String>(headers);
//		ResponseEntity<String> responseEntity = this.restTemplate.exchange("/mustache/5xx", HttpMethod.GET, requestEntity,
//				String.class);
